    ...
    <main class="itemsCenter">
        ...
        <section class="iconMenuWrap">
            <div class="iconMenuCuenta">
                <a href=<?= $rol == 1 ? "/mi-perfil" : "/admin/usuarios"?> class="itemsCenter">
            ...
            <div class="iconMenuCuenta">
                <a href="/admin/productos" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
            ...
            <div class="iconMenuCuenta">
                <a href="/admin/pedidos" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="iconMenuCuenta">
                <a href="/admin/devoluciones" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
            ...
            <div class="iconMenuCuenta">
                <a href="/admin/categorias" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="iconMenuCuenta">
                <a href="/admin/descuentos" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
            ...
            <?php if($rol == 2){ ?>
            <div class="iconMenuCuenta">
                <a href="/admin/informes" class="itemsCenter">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
