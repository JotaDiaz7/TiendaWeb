            ...
            <div id="wrapDates">
                <form id="register" method="post" class="formMain d-flex space-between align-center">
                    <div class="rowForm d-flex">
                        ...
                        <input type="text" name="nombre" id="nombre" maxlength="50" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                        <label for="apellidos">Apellidos</label>
                        <input type="text" name="apellidos" id="apellidos" maxlength="100" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                        <label for="email">Correo electrónico</label>
                        <input type="email" name="email" id="email" maxlength="100" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                        <label for="movil">Móvil</label>
                        <input type="tel" name="movil" id="movil" class="inputForm">
                    </div>
                    <div class="rowFull d-flex">
                        <label for="direccion">Dirección</label>
                        <input type="text" name="direccion" id="direccion" maxlength="500" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                        <label for="ciudad">Ciudad</label>
                        <input type="text" name="ciudad" id="ciudad" maxlength="50" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                        <label for="provincia">Provincia</label>
                        <input type="text" name="provincia" id="provincia" maxlength="50" class="inputForm">
                    </div>
                    <div class="rowForm d-flex">
                    ...
                    <div class="rowSubmit d-flex space-end">
                        <input type="submit" name="submit" id="submitUsuario" value="Registrar" class="button">
                    </div>
                </form>
            </div>
        </section>
        <section>
            <a href="/admin/usuarios">Ver todos los usuarios</a>
        </section>
    </main>
